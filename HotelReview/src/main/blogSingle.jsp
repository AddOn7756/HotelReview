    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="myPage.jsp" class="nav-link">About</a></li>
        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <div class="pt-5 mt-5">
              ...
              <c:if test="${member.id == null }">
                <form action="insertReview" method="post" class="p-5 bg-light">
                  <input type="hidden" name="memNum" value="${member.memNum}">
                  <input type="hidden" name="writer" value="${member.id}">
                  <div class="form-group">
                    <label for="name">로그인 후 사용가능</label>
                ...
                <c:if test="${member.id != null }">
                <form action="insertReview.do" method="post" class="p-5 bg-light">
                  <input type="hidden" name="memNum" value="${member.memNum}">
                  <input type="hidden" name="writer" value="${member.id}">
                  <div class="form-group">
              	...
              	<ul class="comment-list">
               		<li class="comment">
                 		...
                 		<div class="comment-body">
               	  		...
               	  		<c:if test="${v.memNum != member.memNum }">	
                 		<div class="meta">${v.rdate}</div>
                    		<input type="text" class="form-control" name="content" value="${v.content }" readonly>
                    		<%-- <p>${v.content}</p> --%>
                    		<!-- <p><a href="#" class="reply">Reply</a></p> -->
                	 		...
                	 		<form action="deleteReview.do" method="post">
                	 			<input type="hidden" name="reNum" value="${v.reNum }">

    	...
    	<div class="container">
    		<div class="row d-md-flex">
	    		...
	    		<div class="col-md-6 ftco-animate img about-image">
	    			<img alt="" src="images/about.jpg" class="img-fluid">
	    		</div>
	    		<div class="col-md-6 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <h2 class="mb-4">"${member.name }" 마이페이지</h2>
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		              <input type="button" value="회원정보 수정" class="btn btn-primary py-3 px-5" onclick="location.href='editMember.jsp'">
		              <input type="button" value="회원탈퇴" class="btn btn-primary py-3 px-5" onclick="location.href='deleteMember.do'">

      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="h4">회원정보 수정</h2>
          </div>
        	<div class="w-100"></div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 pr-md-5 p-3">
            <form action="editMember.do" method="post">
              ...
              <div class="form-group">
                <input type="text" name="pw" class="form-control" value="${member.pw }">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="text" name="gender" class="form-control" value="${member.gender }" readonly>
              </div>
              <div class="form-group">
